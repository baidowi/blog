...
class PostController extends Controller
{
    ...
    public function destroy($id)
    {
        $post =Posts::findorfail($id);
        $post->delete();
        return redirect()->back()->with('success','Data Berhasil di Delete (silakan cek trashed Post)');
    }
    ...
    public function restore($id){
        ...
        return redirect()->back()->with('success','Data Berhasil di Restore (silakan cek List Post)');
    }
